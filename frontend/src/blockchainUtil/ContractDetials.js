...
export const contractAddress = config.CONTRACT_ADDRESS
export const providerURL = config.PROVIDER_URL
    ...
    "outputs": [
      {
        ...
        "internalType": "struct BlockEdu.Response",
        "name": "",
        "type": "tuple"
      }
    ],
